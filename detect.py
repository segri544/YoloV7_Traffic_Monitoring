...
going=0
array_going=[]
# ser = serial.Serial('COM4', 9600) # set serial port and baud rate
avg_speed=0
i=0
...
def draw_boxes(img, bbox, identities=None, categories=None, names=None, offset=(0, 0)):
    global l2,l1,last_30sec,coming,going,avg_speed,i
    global time1
...
def detect(save_img=False):
    ...
    webcam = (source=="csi") or source.isnumeric() or source.endswith('.txt') or source.lower().startswith(
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            cv2.line(im0,area2_pointA,area2_pointB,(255,255,0),2)
            cv2.line(im0,area2_pointC,area2_pointD,(255,255,0),2)
            color = (0,255,0)
            color2 = (0,0,255)
            ...
            cv2.putText(im0, 'coming Counting = '+str(coming), (160,700), font, fontScale, color2, thickness, cv2.LINE_AA)
            cv2.putText(im0, 'going Counting = '+str(going), (1200,700),font, fontScale, color2, thickness, cv2.LINE_AA)  
            ...
            if  opt.show_fps:
                ...
                cv2.putText(im0, "FPS: " + str(int(fps)), (20, 70), cv2.FONT_HERSHEY_PLAIN, 2, (0,0,255),2) #BGR 
                # print(f"fps:{fps}") --view-img yazmazsan fps baya artıyo
            ##################################
